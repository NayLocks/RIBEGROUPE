 ...
 */
final class Version20220623095947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customers_sheets ADD company_id INT');
        $this->addSql('ALTER TABLE customers_sheets ADD username_id INT');
        $this->addSql('ALTER TABLE customers_sheets ADD CONSTRAINT FK_1EBA44EA979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id)');
        $this->addSql('ALTER TABLE customers_sheets ADD CONSTRAINT FK_1EBA44EAED766068 FOREIGN KEY (username_id) REFERENCES [user] (id)');
        $this->addSql('CREATE INDEX IDX_1EBA44EA979B1AD6 ON customers_sheets (company_id)');
        $this->addSql('CREATE INDEX IDX_1EBA44EAED766068 ON customers_sheets (username_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customers_sheets DROP CONSTRAINT FK_1EBA44EA979B1AD6');
        $this->addSql('ALTER TABLE customers_sheets DROP CONSTRAINT FK_1EBA44EAED766068');
        $this->addSql('DROP INDEX IDX_1EBA44EA979B1AD6 ON customers_sheets');
        $this->addSql('DROP INDEX IDX_1EBA44EAED766068 ON customers_sheets');
        $this->addSql('ALTER TABLE customers_sheets DROP COLUMN company_id');
        $this->addSql('ALTER TABLE customers_sheets DROP COLUMN username_id');
    }
}
